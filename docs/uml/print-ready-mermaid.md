# Food Ordering System - A4 Print Layout
...
```mermaid
%%{init: {'theme':'base','themeVariables': {'fontSize':'14px'}, 'flowchart': {'nodeSpacing': 50, 'rankSpacing': 62}}}%%
flowchart TD
...
```mermaid
%%{init: {'theme':'base','themeVariables': {'fontSize':'14px'}, 'class': {'hideEmptyMembersBox': true}}}%%
classDiagram
        direction LR
